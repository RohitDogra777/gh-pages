var a=Object.defineProperty;var i=(b,t,o)=>t in b?a(b,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):b[t]=o;var e=(b,t,o)=>(i(b,typeof t!="symbol"?t+"":t,o),o);import{s as l,i as c,x as n}from"./lit-element-KtrydcFn.js";import"./Text-DgyPOMwC.js";class s extends l{constructor(){super()}static get properties(){return{label:{type:String},type:{type:String},onClick:{type:Function},size:{type:String},target:{type:String},href:{type:String}}}handleButtonClick(t){t.preventDefault(),this.onClick.call(null,t)}getAnchorTag(){let t="",o="";if(this.size=="Large"?(t="btn-lg",o="btn-link-lg"):this.size=="Medium"&&(t="btn-md",o="btn-link-md"),this.type==="Outline"||this.type==="Solid"){let r="btn";return this.type==="Outline"?r=r+" btn-outline":r=r+" btn-solid",n`<button type="button" part="sn-wc-link"
