import{s as i,x as e}from"./lit-element-KtrydcFn.js";import"./Text-B49plGRa.js";import"./Link-D3jMp8GZ.js";class o extends i{constructor(){super()}static get properties(){return{linkType:{type:String},imageSrc:{type:String},heading:{type:String},subHeading:{type:String},linkLabel:{type:String},handleClick:{type:Object}}}getCardComponent(){}render(){return`${this.type}`,e`
    <style>
    @font-face {
      font-family: 'Lato';
...
}`,...(t=(r=a.parameters)==null?void 0:r.docs)==null?void 0:t.source}}};const m=["Default"];export{a as Default,m as __namedExportsOrder,l as default};
